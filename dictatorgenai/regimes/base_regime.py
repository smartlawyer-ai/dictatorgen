...
class BaseRegime(ABC):
    ...
    @abstractmethod
    def perform_coup(self, general: General):
        """
    ...
    def publish(self, event_type: str, task_id: str, agent: str, message: str, details: Dict = None):
        """
        ...
        self.event_manager.publish(event_type, event)
    ...
    @abstractmethod
    def chat(self, message: str, discussion_id: str = None) -> Generator[str, None, None]:
        """
